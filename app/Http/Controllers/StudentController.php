...
class StudentController extends Controller
{
    ...
    {
        $this->unilog->info("Index method called from StudentController");
    ...
    {
        $this->unilog->alert("Create method called from StudentController");
    ...
    {
        $this->unilog->notice("Store method called from StudentController");
    ...
    {
        $this->unilog->critical("Show method called from StudentController");
        echo "from show";
    }
    ...
    {
        $this->unilog->debug("Edit method called from StudentController");
    ...
    {
        $this->unilog->emergency("Update method called from StudentController");
    ...
    {
        $this->unilog->error("Destroy method called from StudentController");
        //dd($id);
